...
## Cтек исользованных технологий в проекте:
...
- **Управление статусами** (new → favorite → applied → interview → rejected → offer)
- **Фильтрация по названию** в реальном времени
- **Сортировка** по названию, компании, статусу, дате добавления
